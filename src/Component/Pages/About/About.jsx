...
const About = () => {
    return (
      <section className="bg-white bg-opacity-75 py-16" id="about">
        <div className="container mx-auto px-4 lg:px-20">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-gray-600 mb-4">
              Whether you are looking for cutting-edge digital goods or exploring cryptocurrency payment options, BdCoinsPay.com is here to make your shopping experience simple and hassle-free. Discover a new way of shopping that blends technology, convenience, and innovation—all in one place.
              </p>
              <div className="mt-6">
